    ...
    "subParams": [
      {
        ...
        "help": "Learn more how to obtain the Account SID: \u003ca href\u003d\"https://integrations.impact.com/impact-brand/reference/authentication\"\u003e[1]\u003c/a\u003e and \u003ca href\u003d\"https://app.impact.com/secure/advertiser/accountSettings/techintegration/adv-wsapi-table-flow.ihtml\"\u003e[2]\u003c/a\u003e."
      },
      {
        "type": "TEXT",
        "name": "authToken",
        ...
        "help": "Learn more how to obtain the Auth Token: \u003ca href\u003d\"https://integrations.impact.com/impact-brand/reference/authentication\"\u003e[1]\u003c/a\u003e and \u003ca href\u003d\"https://app.impact.com/secure/advertiser/accountSettings/techintegration/adv-wsapi-table-flow.ihtml\"\u003e[2]\u003c/a\u003e."
      },
      {
        "type": "TEXT",
        "name": "eventTypeId",
      ...
      },
      {
        "type": "TEXT",
        "name": "campaignId",
        "displayName": "Campaign/Program ID",
        "simpleValueType": true,
        "valueValidators": [
          {
            "type": "NON_EMPTY"
      ...
      {
        "type": "GROUP",
        "name": "attributionKeysGroup",
        "displayName": "Attribution Keys",
        "groupStyle": "ZIPPY_CLOSED",
        "subParams": [
          {
            "type": "LABEL",
            "name": "attributionKeysGroupLabel",
            "displayName": "At least 1 Attribution Key is required. \u003ca href\u003d\"https://integrations.impact.com/impact-brand/reference/submit-a-conversion#attribution-key\"\u003eLearn more.\u003c/a\u003e\u003cbr/\u003e\u003cbr/\u003e"
          },
          {
            "type": "CHECKBOX",
            "name": "autoMapAttributionKeys",
            "checkboxText": "Automap Attribution Keys",
            "simpleValueType": true,
            "help": "If enabled, the tag will attempt to automatically map parameters from your event data.\n\u003cbr/\u003e\u003cbr/\u003e\nAny value you manually enter in a field below will always override the auto-mapped value.\n\u003cbr/\u003e\u003cbr/\u003e\nDefault mappings:\n\u003cul\u003e\n\u003cli\u003eClick ID:\n\u003cul\u003e\n\u003cli\u003e\u003ci\u003eimpact_cid\u003c/i\u003e cookie\u003c/li\u003e\n\u003c/ul\u003e\n\u003c/li\u003e\n\u003c/ul\u003e",
            "defaultValue": true
          },
          {
            "type": "SIMPLE_TABLE",
            ...
            "simpleTableColumns": [
              {
                ...
                "selectItems": [
                  ...
                  },
                  {
                    ...
                    "displayValue": "Custom Profile ID"
                  },
                  {
                    "value": "OrderPromoCode",
                    "displayValue": "Order Promo Code"
                  },
                  {
                    "value": "UniqueUrl",
                    "displayValue": "Unique URL"
                  },
                  {
                    "value": "GoogAId",
                    "displayValue": "Google Advertising ID"
                  },
                  {
                    "value": "AppleIfa",
                    "displayValue": "Apple IDFA"
                  },
                  {
                    "value": "AppleIfv",
                    "displayValue": "Apple IDFV"
                  },
                  {
                    "value": "MediaId",
                    "displayValue": "Media ID"
                  },
                  {
                    "value": "PhoneNumber",
...
2026-04-22 - Change Notes:
  ...
  - Add documentation links to Account SID and Auth Token fields
  - Fix label casing: "Program ID" → "Campaign/Program ID", "Order Id" → "Order ID", "Url parameter name for obtaining Impact clickid" → "URL parameter name for obtaining Impact Click ID"
  - Guard product array iteration with getType() === 'array'; add NON_EMPTY validation to additional parameters name field
